...
public class FavoriteWithoutCPAdapter extends RecyclerView.Adapter<FavoriteWithoutCPAdapter.FavoriteWithoutCPViewHolder>{

    private List<Favorite> favorites;
    private Context context;
    private FavoriteDatabase db;

    public class FavoriteWithoutCPViewHolder extends RecyclerView.ViewHolder{

        ImageView avatar;
        TextView title;
        Button favoriteButton;

        public FavoriteWithoutCPViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public FavoriteWithoutCPAdapter(Context context, List<Favorite> favoriteList) {
    ...
    @NonNull
    @Override
    public FavoriteWithoutCPViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_favorite, parent, false);
        return new FavoriteWithoutCPViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteWithoutCPViewHolder holder, int position) {
